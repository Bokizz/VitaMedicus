...
class Appointment(models.Model):
    ...
    def __str__(self):
        return f"{self.patient.first_name} {self.patient.last_name} бара термин за {self.service.name} кај Доктор {self.doctor.first_name} {self.doctor.last_name} на дата {self.date} во {self.start_time} часот."
